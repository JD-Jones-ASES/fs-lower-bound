...
\author{JD Jones}
% TODO(JD): fill in before submission, or delete.
% \email{...}
...
\texttt{Classical.choice}, \texttt{Quot.sound}). The formalization is at
\url{https://github.com/JD-Jones-ASES/fs-lower-bound-lean}; the note's
repository, including the verification script, is at
